...
The query suggestions also appear in a table with their type and cosine similarity score, and you can download the full list as a CSV file for further analysis.
